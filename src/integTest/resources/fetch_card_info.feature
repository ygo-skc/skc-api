Feature: Fetch information about an individual card.
    ...
    Scenario Outline: Fetching information about a card and checking if response has the necessary attributes and values (see other scenarios for more specific value checks).
