Feature: Fetch information about an individual card.
    ...
    Scenario Outline: Fetching all information about a card and checking if response has the necessary attributes and values (see other scenarios for more specific value checks).
        ...
        And products card is found in should be greater than <productsFoundIn>
        And ban lists card is found in should be greater than <restrictedIn>

        Examples:
            | cardID   | cardName                                | cardColor        | cardAttribute | monsterType                     | monsterAtk | monsterDef | httpStatus | productsFoundIn  | restrictedIn  |
            | 21844576 | Elemental HERO Avian                    | Normal           | Wind          | Warrior/Normal                  | 1000       | 1000       | 200        | 5                | 0                |
            | 40044918 | Elemental HERO Stratos                  | Effect           | Wind          | Warrior/Effect                  | 1800       | 300        | 200        | 4                | 14               |
            ...
            | 67865534 | Magician of Hope                        | Pendulum-Xyz     | Light         | Spellcaster/Xyz/Pendulum/Effect | 2500       | 2000       | 200        | 1                | 0                |
            | 90036274 | Clear Wing Fast Dragon                  | Pendulum-Synchro | Wind          | Dragon/Synchro/Pendulum/Effect  | 2500       | 2000       | 200        | 1                | 0                |
    ...
    Scenario Outline: Fetching information (without all info flage) about a card and checking if response has the necessary attributes and values (see other scenarios for more specific value checks).
