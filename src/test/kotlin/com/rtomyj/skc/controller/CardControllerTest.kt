...
import com.rtomyj.skc.service.CardService
import com.rtomyj.skc.util.ControllerTestUtil
    ...
    inner class UnhappyPath {
        ...
        fun `Fetching Card Information Using Card ID - Card Requested Is Not In DB - HTTP 404 Error`() {
            ...
            `when`(cardService.getCardInfo(TestConstants.STRATOS_ID, true, TestConstants.MOCK_IP)).thenThrow(
                SKCException(
                    String.format(ErrConstants.CARD_ID_REQUESTED_NOT_FOUND_IN_DB, TestConstants.STRATOS_ID),
                    ErrorType.DB001,
                ),
            )
