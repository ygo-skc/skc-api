...
@ContextConfiguration(classes = [JDBCDao::class, DateConfig::class, JsonMapper::class])
...
class JdbcDaoTest {
  ...
  inner class HappyPath {
    ...
    fun testFetchingCardById_Success() {
      ...
      Assertions.assertNotNull(stratosDbResult.monsterAssociation)
      ...
      Assertions.assertNull(aHeroLivesDbResult.monsterAssociation)
      ...
      Assertions.assertNotNull(dMaliDbResult.monsterAssociation)
    }
  }
