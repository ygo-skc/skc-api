...
class BannedCardsServiceTest {
    ...
    init {
        ...
        banListInstanceFullText =
            mapper.readValue(
                ClassPathResource(TestConstants.BAN_LIST_INSTANCE_JSON_FILE).file,
                BanListInstance::class.java,
            )
    ...
    inner class HappyPath {
         ...
         */
        private fun assertFetchAllInfoValues(
            banListInstance: BanListInstance,
            fetchAllInfo: Boolean,
        ) {
            if (fetchAllInfo) {
                ...
                Assertions.assertEquals(
                    TestConstants.STRATOS_NAME,
                    banListInstance.removedContent!!
                        .removedCards[0]
                        .card.cardName,
                )
                Assertions.assertEquals(
