...
class ProductJDBCDao @Autowired constructor(
    ...
    override fun getProductContents(
        ...
        val cardPositionInProductMapsCardInfo = HashMap<String, ProductContent>() // map will store references to ProductContent where each ProductContent is equivalent to a cards position ina product eg: 001
