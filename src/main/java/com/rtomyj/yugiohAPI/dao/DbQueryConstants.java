...
public class DbQueryConstants
{
	...
	public static final String GET_product_RARITY_INFO = "SELECT card_rarity, count(*) FROM product_details WHERE product_id = :packId GROUP BY card_rarity ORDER by card_rarity";
