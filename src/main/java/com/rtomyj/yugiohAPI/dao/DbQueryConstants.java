...
public class DbQueryConstants
{
	...
	public static final String GET_AVAILABLE_PACKS = "SELECT product_id, product_locale, product_name, product_release_date, product_content_total, product_type FROM product_info where product_type = :productType";
