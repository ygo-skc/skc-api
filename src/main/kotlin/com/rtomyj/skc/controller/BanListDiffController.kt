...
import com.rtomyj.skc.service.BanListDiffService
...
class BanListDiffController
    ...
    constructor(
        ...
        @Operation(
            summary =
                "Retrieve cards that are either newly added to desired ban list or cards that have switched statuses (ie: from forbidden to limited) relative to desired ban list " +
            ...
            ReactiveMDC.deferMDC(
                Mono
                    .fromCallable {
                        ...
                        log.info(
                            "Retrieving new ban list content for ban list w/ start date {} & format {}",
                            banListStartDate,
                            format,
                        )
                    },
