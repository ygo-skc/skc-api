 ...
 */ @Autowired constructor(
	...
	): ResponseEntity<BanListDates> {
		log.info("User is retrieving all effective start dates for ban lists using format {}.", format)

		val banListDates = banListDatesService.retrieveBanListStartDates(format)
		log.info(
			"Successfully retrieved all effective start dates for ban list using format {}. Currently there are {} ban lists", format,
