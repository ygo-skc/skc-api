...
@Service
class SuggestionEngineStatusService
    @Autowired
    constructor(
        ...
        fun getStatus(): Mono<DownstreamStatus> =
            suggestionEngineClient
                ...
                .doOnError(DownStreamException::class.java) { ex ->
                    ...
                    log.error(
                        "Error occurred while fetching SKC Suggestion Engine status. Body: {}",
                        ex.message,
                    )
                    throw SKCException("Suggestion Engine status check failed.", ErrorType.DS001)
                }.doOnRequest {
                    ...
                    val failedSuggestionEngineDownstreamServices =
                        suggestionEngineStatus.downstream
                    ...
                    DownstreamStatus(
                        ...
                        suggestionEngineStatus.version,
