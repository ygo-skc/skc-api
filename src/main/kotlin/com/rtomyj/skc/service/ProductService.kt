...
import com.rtomyj.skc.service.TrafficService
...
class ProductService @Autowired constructor(
  ...
  fun getSingleProductUsingLocale(productId: String, locale: String, clientIP: String): Mono<Product> = Mono
      .zip(
        blockingJDBCMono { productDao.getProductInfo(productId, locale) },
        blockingJDBCMono { productDao.getProductContents(productId, locale) },
