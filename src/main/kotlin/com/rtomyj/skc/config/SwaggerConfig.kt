        ...
        OpenAPI()
            .info(
                Info()
                    .title("SKC API")
                    .description(
                        "Application Programming Interface (or API for short) for interfacing with a Database that contains information such as Ban List dates/content, Yu-Gi-Oh! product information, card information, etc.",
        ...
        Components()
            ...
            .addSchemas(
                ...
                Schema<String>()
                    .type("string")
                    .description(
                        "A string identifier used by API/DB to separate, distinguish and group product types to further distinguish products.",
                    ).example("Core Set"),
            ).addSchemas(
                "skcError",
                Schema<SKCError>()
            ...
            .addResponses(
                ...
                ApiResponse()
                    ...
                    .content(
                        Content().addMediaType(APPLICATION_JSON_VALUE, MediaType().schema(Schema<SKCError>().`$ref`("skcErrorBadRequest"))),
                    ),
            ).addResponses(
                "notFound",
                ApiResponse()
                    ...
                    .content(
                        Content().addMediaType(APPLICATION_JSON_VALUE, MediaType().schema(Schema<SKCError>().`$ref`("skcErrorNotFound"))),
                    ),
            ).addResponses(
                "unprocessableEntity",
                ApiResponse()
                    ...
                    .content(
                        Content().addMediaType(
                            ...
                            MediaType().schema(Schema<SKCError>().`$ref`("skcErrorUnprocessableEntity")),
                        ),
                    ),
            ).addResponses(
                "internalServerError",
                ApiResponse()
                    ...
                    .content(
                        Content().addMediaType(
                            APPLICATION_JSON_VALUE,
                            MediaType().schema(Schema<SKCError>().`$ref`("skcErrorInternalServerError")),
                        ),
                    ),
            )
            // parameters
