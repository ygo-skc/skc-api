...
class ProductJDBCDao
    ...
    constructor(
        ...
        companion object {
            ...
            private val GET_AVAILABLE_PRODUCTS_BY_LOCALE =
                String.format(
                    ...
                    return@queryForObject Product(productId, locale)
                        .apply {
                            ...
                            try {
                                productReleaseDate =
                                    LocalDate.parse(
                                        row.getString(ProductsTableDefinition.PRODUCT_RELEASE_DATE.toString()),
                                        dbDateFormatter,
                                    )
        ...
        override fun getProductDetailsForCard(cardId: String): MutableList<Product> {
            ...
            jdbcNamedTemplate.query(GET_PRODUCT_INFO_FOR_CARD, sqlParams) { row: ResultSet, _: Int ->
                ...
                val productContent =
                    productMap
                        .getOrPut("$productId-$cardPosition") {
        ...
        override fun getAllProductsByType(
