...
class CardSearchJDBCDao
    ...
    constructor(
        ...
        override fun searchCard(
            cardSearchParameters: CardSearchParameters,
            getBanInfo: Boolean,
        ): List<Card> = if (getBanInfo) searchForCardsIncludeBanInfo(cardSearchParameters) else searchForCards(cardSearchParameters)
