...
interface BanListDao {
     ...
     */
    fun getRemovedContentOfBanList(
        banListDate: String,
        previousBanListDate: String,
        format: String,
    ): List<CardsPreviousBanListStatus>
     ...
     */
    fun getCardBanListStatusByDate(
        cardId: String,
        banListDate: String,
    ): String
}
