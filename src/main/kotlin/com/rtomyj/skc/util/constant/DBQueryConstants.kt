...
FROM card_info $WHERE_CARD_NUMBER_IS_CARD_ID"""

  const val GET_BAN_LIST_BY_STATUS =
    """SELECT card_name, monster_type, card_color, card_effect, card_number, card_attribute, monster_association
FROM ban_list_info
...
WHERE product_type = :productType"""
  ...
  const val GET_PRODUCT_RARITY_INFO =
    """SELECT card_rarity, count(*) FROM product_details
