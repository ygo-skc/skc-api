...
INSERT INTO cards(
	...
	VALUES (
		'76794549', (select color_id from card_colors where card_color = 'Pendulum-Effect'), 'Astrograph Sorcerer', 'Dark',
		"Pendulum Effect
...
If a card(s) you control is destroyed by battle or card effect: You can Special Summon this card from your hand, then you can choose 1 monster in the Graveyard, Extra Deck, or that is banished, and that was destroyed this turn, and add 1 monster with the same name from your Deck to your hand. You can banish this card you control, plus 4 monsters from your hand, field, and/or Graveyard (1 each with 'Pendulum Dragon', 'Xyz Dragon', 'Synchro Dragon', and 'Fusion Dragon' in their names); Special Summon 1 'Supreme King Z-ARC' from your Extra Deck. (This is treated as a Fusion Summon.)"
	...
	, (
		'49684352', (select color_id from card_colors where card_color = 'Pendulum-Effect'), 'Double Iris Magician', 'Dark',
		"Pendulum Effect
Once per turn: You can target 1 DARK Spellcaster-Type monster you control; apply this effect to it, then destroy this card. Once applied, double any battle damage that monster inflicts to your opponent this turn if it battles an opponent's monster.
...
If this card is destroyed by battle or card effect: You can add 1 'Pendulumgraph' card from your Deck to your hand."
	...
	, (
		'31178212', (select color_id from card_colors where card_color = 'Pendulum-Effect'), 'Majespecter Unicorn - Kirin', 'Wind',
	...
	, (
		'07563579', (select color_id from card_colors where card_color = 'Pendulum-Effect'), 'Performage Plushfire', 'Fire',
		"Pendulum Effect
...
If this card on the field is destroyed by battle or card effect: You can Special Summon 1 'Performage' monster from your hand or Deck, except 'Performage Plushfire'."
	...
	, (
		'17330916', (select color_id from card_colors where card_color = 'Pendulum-Effect'), 'Performapal Monkeyboard', 'Earth',
		"Pendulum Effect
...
You can discard this card; reveal 1 'Performapal' or 'Odd-Eyes' monster in your hand, and if you do, reduce the Levels of monsters in your hand with that name by 1 for the rest of this turn (even after they are Summoned/Set)."
	...
	, (
		'40318957', (select color_id from card_colors where card_color = 'Pendulum-Effect'), 'Performapal Skullcrobat Joker', 'Dark',
		"Pendulum Effect
...
Cannot Special Summon Fusion, Synchro or Xyz Monsters using this card as a Material, except 'Dracoslayer' monsters."
	...
	, (
		...
		"Pendulum Effect
If you have a 'Magician' or 'Performapal' card in your other Pendulum Zone: You can destroy this card, and if you do, place 1 'Magician' Pendulum Monster from your Deck in your Pendulum Zone, except 'Wisdom-Eye Magician'.
