...
cf mysql ${DB_NAME} -f < "2015-11-09_ban_list.sql"
cf mysql ${DB_NAME} -f < "2016-04-11_ban_list.sql"
cf mysql ${DB_NAME} -f < "2016-08-29_ban_list.sql"
...
cf mysql ${DB_NAME} -f < "2020-01-20_ban_list.sql"